...
// Always the UK's own date, whatever timezone a customer's device happens
// to be set to - the reset always happens at UK midnight, correctly
// accounting for GMT/BST, rather than each customer's own local day
